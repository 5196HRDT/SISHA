...
Public Class frmRepEmergencia
    Dim objEmergenciaSer As New clsEmergenciaSer

    Private Sub frmRepEmergencia_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnMostrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMostrar.Click
        ...
        'Detallado
        dsVer = objEmergenciaSer.ReporteLab1(DameNumeroMes(cboMes.Text), txtAño.Value, cboTipo.Text)
        ...
        End If
        'Total
        dsVer = objEmergenciaSer.ReporteLab2(DameNumeroMes(cboMes.Text), txtAño.Value)
        If dsVer.Tables(0).Rows.Count > 0 Then
            Dim I As Integer
            Dim Fila As ListViewItem
            For I = 0 To dsVer.Tables(0).Rows.Count - 1
    ...
    Private Sub cboMes_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboMes.SelectedIndexChanged
        If cboMes.Text <> "" Then
            Dim dsVer As New DataSet
            dsVer = objEmergenciaSer.ReporteTipoPac(DameNumeroMes(cboMes.Text), txtAño.Value)
            If dsVer.Tables(0).Rows.Count > 0 Then
                cboTipo.DataSource = dsVer.Tables(0)
                cboTipo.DisplayMember = "TipoAtencion"
                cboTipo.ValueMember = "TipoAtencion"
            End If
        End If
    End Sub
