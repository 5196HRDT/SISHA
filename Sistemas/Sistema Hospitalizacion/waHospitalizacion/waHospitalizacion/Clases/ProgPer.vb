...
Public Class ProgPer
    ...
    Public Sub Grabar(ByVal IdProgPer As String, ByVal FechaRegistro As String, ByVal Fecha As String, ByVal IdCargo As String, ByVal IdPersonal As String, ByVal IdSala As String, ByVal Oper As String)
    ...
    Public Function BuscarReporte(ByVal Fecha As String, ByVal Tipo As String) As Data.DataSet
        BuscarReporte = New Data.DataSet
        Dim daTabla As New SqlDataAdapter("CQProgPer_BuscarReporte", CN)
        Dim dsTabla As New Data.DataSet
        daTabla.SelectCommand.CommandType = CommandType.StoredProcedure
        daTabla.SelectCommand.Parameters.Add("@Fecha", SqlDbType.SmallDateTime).Value = Fecha
