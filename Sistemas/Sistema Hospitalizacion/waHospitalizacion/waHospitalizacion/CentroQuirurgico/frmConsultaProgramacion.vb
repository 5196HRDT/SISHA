Public Class frmConsultaProgramacion
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        dsProgPer = objProgPer.BuscarReporte(Microsoft.VisualBasic.Format(dtpFecha.Value, "dd/MM/yyyy"), "ANESTESIOLOGO")
        ...
        dsProgPer = objProgPer.BuscarReporte(Microsoft.VisualBasic.Format(dtpFecha.Value, "dd/MM/yyyy"), "CIRCULANTE")
        For I = 0 To dsProgPer.Tables(0).Rows.Count - 1
        ...
        dsProgPer.Tables.Clear()
        dsProgPer = objProgPer.BuscarReporte(Microsoft.VisualBasic.Format(dtpFecha.Value, "dd/MM/yyyy"), "INST.")
        For I = 0 To dsProgPer.Tables(0).Rows.Count - 1
            lstCirculante.Items.Add("INST." & dsProgPer.Tables(0).Rows(I)("Nombres"))
        Next

        dsProgPer.Tables.Clear()
        dsProgPer = objProgPer.BuscarReporte(Microsoft.VisualBasic.Format(dtpFecha.Value, "dd/MM/yyyy"), "URPA")
        For I = 0 To dsProgPer.Tables(0).Rows.Count - 1
        ...
        dsOperacion = objProgramacion.BuscarReporte(Microsoft.VisualBasic.Format(dtpFecha.Value, "dd/MM/yyyy"))
