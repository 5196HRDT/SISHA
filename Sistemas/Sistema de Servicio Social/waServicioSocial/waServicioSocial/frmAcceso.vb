Public Class frmAcceso
    ...
    Private Sub btnAceptar_Click(sender As System.Object, e As System.EventArgs) Handles btnAceptar.Click
        ...
        If dsTabla.Tables(0).Rows.Count > 0 Then
            ...
            If Inicial = "1" Then
                If dsTabla.Tables(0).Rows(0)("Nivel") = "ASISTENTADO" Then
                    Me.Hide()
                    frmMenu.Show()
                Else
                    MessageBox.Show("Nivel de Usuario no es válido para éste módulo", "Mensaje de Información", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    txtUsuario.Text = ""
                    txtClave.Text = ""
                    txtUsuario.Select()
                End If
