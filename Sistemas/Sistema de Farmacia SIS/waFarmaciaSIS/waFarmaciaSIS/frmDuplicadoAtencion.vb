Public Class frmDuplicadoAtencion
    ...
    Private Sub frmDuplicadoAtencion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cboOrigen_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cboOrigen.KeyDown
        If e.KeyCode = Keys.Enter And cboOrigen.Text <> "" Then txtPaciente.Select()
    End Sub
    ...
    Private Sub btnMostrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMostrar.Click
        ...
        Dim IdSIS As String
        dsVer = objReceta.BuscarDuplicado(cboOrigen.Text, dtpFecha.Value.ToShortDateString, txtPaciente.Text)
        Dim I As Integer
    ...
    Private Sub btnAtencion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAtencion.Click
        ...
        If MessageBox.Show("Esta seguro de realizar Duplicado de Atención de Farmacia?", "Mensaje de Consulta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
