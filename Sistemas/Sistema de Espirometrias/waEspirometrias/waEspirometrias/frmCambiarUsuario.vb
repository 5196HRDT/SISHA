Public Class frmCambiarUsuario
    ...
    Private Sub frmCambiarUsuario_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Application.Exit()
    End Sub
    ...
    Private Sub txtCClave_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCClave.TextChanged
