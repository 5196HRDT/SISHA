Public Class frmConsultaProgramacion
    ...
    Private Sub frmConsultaProgramacion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        For I = 0 To dsOperacion.Tables(0).Rows.Count - 1
            ...
            Fila.SubItems.Add(dsOperacion.Tables(0).Rows(I)("TipoCirugia").ToString)
        Next
    End Sub
    ...
    Private Sub pdcDocumento_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles pdcDocumento.PrintPage
        ...
        Dim I As Integer
        Dim TotalMayor As Integer = 0
        Y = 30
        Filas = 10
        If cboOrigenSala.Text = "PRINCIPAL" Then
        ...
        Else
            e.Graphics.DrawString("Hospital Regional Docente de Trujillo" & StrDup(75, " ") & "Cirugía de Día", FuenteEnc, Pincel, 4, Y)
        End If
        Y = Y + 20
        With e.Graphics
            ...
            .DrawString("ANESTESIOLOGOS" & StrDup(35, " ") & "CIRCULANTES", Fuente, Pincel, 50, Y)
            Y = Y + 20
            If lstAnestesiologo.Items.Count >= lstCirculante.Items.Count Then TotalMayor = lstAnestesiologo.Items.Count - 1 Else TotalMayor = lstCirculante.Items.Count - 1
            For I = 0 To TotalMayor
                If I <= lstAnestesiologo.Items.Count - 1 Then
                    .DrawString(Microsoft.VisualBasic.Left(lstAnestesiologo.Items(I).ToString & StrDup(30, " "), 30), FuenteE, Pincel, 50, Y)
                End If
                If I <= lstCirculante.Items.Count - 1 Then
                    .DrawString(StrDup(70, " ") & lstCirculante.Items(I).ToString, FuenteE, Pincel, 50, Y)
                End If

                Y = Y + 20
            Next
            If cboOrigenSala.Text = "CIRUGIA DE DIA" Then Y = Y + 30
            .DrawString("HC" & StrDup(4, " ") & "NOMBRES DEL PACIENTE" & StrDup(4, " ") & "TIP " & "EDAD" & StrDup(2, " ") & "SERV" & StrDup(10, " ") & "OPERACION" & StrDup(14, " ") & "HORA" & StrDup(1, " ") & "SALA" & StrDup(1, " ") & "ANEST" & StrDup(6, " ") & "CIRUJANO" & StrDup(4, " ") & "TIPOCIR", FuenteE, Pincel, 40, Y)
            Y = Y + 18
