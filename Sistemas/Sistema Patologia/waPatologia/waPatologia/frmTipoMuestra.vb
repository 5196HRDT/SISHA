Public Class frmTipoMuestra
    ...
    Private Sub Buscar(ByVal Filtro As String)
        ...
        dsTabla = objTipoMuestra.Buscar(1, Filtro)
        For Me.I = 0 To dsTabla.Tables(0).Rows.Count - 1
            Fila = lvTabla.Items.Add(dsTabla.Tables(0).Rows(I)("IdTipoMuestra"))
    ...
    Private Sub frmTipoMuestra_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        If MessageBox.Show("Esta seguro de Guardar la Información", "Mensaje de Consulta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            ...
            objTipoMuestra.Mantenimiento(CodLocal, txtDescripcion.Text, Activo, Oper)
        End If
        btnCancelar_Click(sender, e)
    End Sub
