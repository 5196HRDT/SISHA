...
Public Class clsOrgano
    Public Sub Mantenimiento(ByVal IdOrgano As String, ByVal Descripcion As String, ByVal Activo As String, ByVal Oper As String)
        Do While Cn.State = ConnectionState.Closed
            Cn.Open()
        Loop
        Dim daTabla As New SqlDataAdapter("Organo_Mantenimiento", Cn)
    ...
    Public Function Buscar(ByVal Oper As String, ByVal Filtro As String) As Data.DataSet
        Do While Cn.State = ConnectionState.Closed
            Cn.Open()
        Loop
        Dim daTabla As New SqlDataAdapter("Organo_Buscar", Cn)
