...
Module mConexion
    ...
    Public CnP As New SqlConnection

    Public Sub AbrirBase()
        Dim Ruta, Servidor, Base, Usuario, Password, BasePato As String
        ...
        BasePato = Microsoft.VisualBasic.Right(arrText(5), arrText(5).ToString.Length - 9)

        'Consultorio
        Cn.ConnectionString = "Database='" + Base + "';Data Source='" + Servidor + "';User Id='" + Usuario + "';Password='" + Password + "'"

        'Patologia
        CnP.ConnectionString = "Database='" + BasePato + "';Data Source='" + Servidor + "';User Id='" + Usuario + "';Password='" + Password + "'"
