...
Public Class frmCausas
    ...
    Private Sub btnMostrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMostrar.Click
        ...
        dsCIE = objReferencia.BuscarCIE(dtpF1.Value.ToShortDateString, dtpF2.Value.ToShortDateString)
    ...
    Private Sub btnExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExcel.Click
        ...
        For I = 0 To lvLista1.Columns.Count - 1
            oSheet.Range(Columna & "3").Value = lvLista1.Columns(I).Text
            If Columna = "Z" Then
                Columna = "AA"
            Else
        ...
        Columna = "A"
        If lvLista1.Items.Count > 0 Then
            Dim Col As Integer = 5
            For I = 0 To lvLista1.Items.Count - 1
                Columna = "A"
                For J = 0 To lvLista1.Columns.Count - 1
                    oSheet.Range(Columna & (I + 4)).Value = lvLista1.Items(I).SubItems.Item(J).Text.ToString
                    If Columna = "Z" Then
                        Columna = "AA"
                    Else
                        If Columna.Length = 1 Then
    ...
    Private Sub btnMostrar1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMostrar1.Click
        ...
        dsCIE = objReferencia.BuscarCIEMA(cboMes.Text, cboAño.Text)
        For I = 0 To dsCIE.Tables(0).Rows.Count - 1
            For J = 0 To 3
                If dsCIE.Tables(0).Rows(I)(J) <> "" Then objTemporal.Grabar(dsCIE.Tables(0).Rows(I)(J))
            Next
