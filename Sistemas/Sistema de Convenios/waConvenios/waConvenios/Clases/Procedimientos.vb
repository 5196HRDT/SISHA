...
Public Class Procedimientos
    ...
    Public Function BuscarTarifarioCon(ByVal IdTipoTarifa As String, ByVal Des As String) As Data.DataSet
        Dim daTabla As New SqlDataAdapter("ServicioItem_BuscarTarifarioCon", Cn)
        Dim dstabla As New Data.DataSet
        daTabla.SelectCommand.CommandType = CommandType.StoredProcedure
    ...
    Public Function BuscarTarifarioConDes(ByVal IdTipoTarifa As String, ByVal Des As String) As Data.DataSet
        Dim daTabla As New SqlDataAdapter("ServicioItem_BuscarTarifarioConDes", Cn)
        Dim dstabla As New Data.DataSet
        daTabla.SelectCommand.CommandType = CommandType.StoredProcedure
        daTabla.SelectCommand.Parameters.Add("@IdTipoTarifa", SqlDbType.Int).Value = IdTipoTarifa
        daTabla.SelectCommand.Parameters.Add("@Descripcion", SqlDbType.VarChar).Value = Des
    ...
    Public Function BuscarTarifarioComun(ByVal Des As String) As Data.DataSet
