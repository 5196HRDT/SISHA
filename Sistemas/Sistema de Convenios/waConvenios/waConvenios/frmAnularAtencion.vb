Public Class frmAnularAtencion
    ...
    Private Sub btnBuscarH_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscarH.Click
        ...
        If txtHistoria.Text.Length > 0 Then
            ...
            dsTabla = objConvenio.VerificarConvenio(txtHistoria.Text)
    ...
    Private Sub btnAnular_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAnular.Click
        If MessageBox.Show("Esta seguro de Anular Atencion de Convenio", "Mensaje de Consulta", MessageBoxButtons.YesNo, MessageBoxIcon.Information) = Windows.Forms.DialogResult.Yes Then
            objConvenio.AnularAtencion(CodLocal, Microsoft.VisualBasic.Format(Date.Now, "dd/MM/yyyy"), Microsoft.VisualBasic.Timer, UsuarioSistema, My.Computer.Name)
            MessageBox.Show("Se Anulo Atencion de Convenio Satisfactoriamente", "Mensaje de Informacion", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
