Public Class frmRecuperarAltaSIS
        ...
        If e.KeyChar = Convert.ToChar(Keys.Enter) And txtNumero.Text.Length > 0 Then
            ...
            If dsTabla.Tables(0).Rows.Count > 0 Then
                If dsTabla.Tables(0).Rows(0)("IdResponsable").ToString = "" Then
                    ...
                    btnAnular.Select()
                Else
                    If MessageBox.Show("Hoja HIS ya Fue Dada de Alta" & Chr(13) & "Desea recuperar alta de SIS", "Mensaje de Consulta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                        CodSis = dsTabla.Tables(0).Rows(0)("IdSIS")
                        lblDISAHEI.Text = dsTabla.Tables(0).Rows(0)("DISAHEI")
                        cboLoteA.Text = dsTabla.Tables(0).Rows(0)("LOTEDISA")
                        txtNumeroA.Text = dsTabla.Tables(0).Rows(0)("NumeroDISA")
    ...
    Private Sub frmRecuperarAltaSIS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        btnCancelar_Click(sender, e)
        lblHEI.Text = "LIB"
        lblDISAHEI.Text = "LIB"
    End Sub
    ...
    Private Sub btnAnular_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAnular.Click
        If MessageBox.Show("Esta seguro de Recuperar Alta de Paciente", "Mensaje de Consulta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            objSIS.RecuperarAlta(CodSis)
        End If
        btnCancelar_Click(sender, e)
    End Sub
