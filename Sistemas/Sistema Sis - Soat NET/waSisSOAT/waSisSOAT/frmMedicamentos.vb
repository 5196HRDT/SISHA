Public Class frmMedicamentos
    ...
    Private Sub txtFiltro_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtFiltro.TextChanged
        Select Case Filtro
            Case "MEDICINA"
                ...
                rsExa = objMedicina.BuscarMedicina(txtFiltro.Text & "%", 1, "D")
    ...
    Private Sub btnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        If MessageBox.Show("Esta seguro de Grabar la Información", "Mensaje de Consulta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            Dim I As Integer
            For I = 0 To lvDet.Items.Count - 1
                objSis.GrabarMedicamentos(CodSis, lvDet.Items(I).SubItems(0).Text, lvDet.Items(I).SubItems(1).Text, lvDet.Items(I).SubItems(2).Text, lvDet.Items(I).SubItems(3).Text, lvDet.Items(I).SubItems(4).Text)
            Next
        End If
        btnCancelar_Click(sender, e)
    End Sub
    ...
    Private Sub cboLoteA_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboLoteA.SelectedIndexChanged

    End Sub

    Private Sub txtNumeroA_MaskInputRejected(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MaskInputRejectedEventArgs) Handles txtNumeroA.MaskInputRejected
