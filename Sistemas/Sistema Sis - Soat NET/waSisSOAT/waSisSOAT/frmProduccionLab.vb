Public Class frmProduccionLab
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        lblCant.Text = "0.00"
        lblImp.Text = "0.00"
        dsVer = objProduccion.Produccion(Microsoft.VisualBasic.Format(dtpF1.Value, "dd/MM/yyyy"), Microsoft.VisualBasic.Format(dtpF2.Value, "dd/MM/yyyy"), "LABORATORIO", "", "", "", 12)
        lvG.Items.Clear()
        Dim I As Integer
    ...
    Private Sub Encabezado(ByVal Imp As System.Drawing.Printing.PrintPageEventArgs)
        With Imp.Graphics
            ...
            .DrawString("REPORTE PRODUCCION DE LABORATORIO DEL SIS ENTRE EL " & dtpF1.Value.ToShortDateString & " Y EL " & dtpF2.Value.ToShortDateString, Fuente, Pincel, 20, Y)
            Y = Y + 10
    ...
    Private Sub frmProduccionLab_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
