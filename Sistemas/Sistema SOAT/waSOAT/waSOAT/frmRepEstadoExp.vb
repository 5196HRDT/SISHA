Public Class frmRepEstadoExp
    ...
    Private Sub frmRepEstadoExp_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'Aseguradora
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        For I = 0 To dsTab.Tables(0).Rows.Count - 1
            ...
            If dsTab.Tables(0).Rows(I)("FechaAnulado").ToString = "" Then Fila.SubItems.Add(Total) Else Fila.SubItems.Add("0.00")
            Fila.SubItems.Add(dsTab.Tables(0).Rows(I)("IdSoat"))
            Fila.SubItems.Add(Microsoft.VisualBasic.Left(dsTab.Tables(0).Rows(I)("FechaFacturado").ToString & StrDup(10, " "), 10))
            Fila.SubItems.Add(Microsoft.VisualBasic.Left(dsTab.Tables(0).Rows(I)("FechaCancelado").ToString & StrDup(10, " "), 10))
            Fila.SubItems.Add(Microsoft.VisualBasic.Left(dsTab.Tables(0).Rows(I)("FechaCanceladoF").ToString & StrDup(10, " "), 10))
            Fila.SubItems.Add(Microsoft.VisualBasic.Left(dsTab.Tables(0).Rows(I)("FechaAnulado").ToString & StrDup(10, " "), 10))
    ...
    Private Sub pdcDocumento_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles pdcDocumento.PrintPage
        ...
        With e.Graphics
            ...
            Y = Y + 20
            .DrawString("    Aseguradora           Fecha     Historia   Paciente            Liqui    FAlta     FecFac    FecCanPro     FecCanFar    Total   FecAnulado", FuenteF, Pincel, 50, Y)
            Y = Y + 15
            ...
            Do While TotalFilas >= 0
                ...
                FFac = Microsoft.VisualBasic.Left(lvDet.Items(I).SubItems(10).Text & StrDup(10, " "), 10)
                FCP = Microsoft.VisualBasic.Left(lvDet.Items(I).SubItems(11).Text & StrDup(10, " "), 10)
                FCF = Microsoft.VisualBasic.Left(lvDet.Items(I).SubItems(12).Text & StrDup(10, " "), 10)
                Anulado = Microsoft.VisualBasic.Left(lvDet.Items(I).SubItems(13).Text & StrDup(10, " "), 10)
                ...
                .DrawString(NPre, FuenteF, Pincel, 520, Y)
                .DrawString(Microsoft.VisualBasic.Left(FAlta & StrDup(10, " "), 10), FuenteF, Pincel, 550, Y)
                .DrawString(Microsoft.VisualBasic.Left(FFac & StrDup(10, " "), 10), FuenteF, Pincel, 630, Y)
                .DrawString(Microsoft.VisualBasic.Left(FCP & StrDup(10, " "), 10), FuenteF, Pincel, 710, Y)
                .DrawString(Microsoft.VisualBasic.Left(FCF & StrDup(10, " "), 10), FuenteF, Pincel, 790, Y)
                .DrawString(Microsoft.VisualBasic.Right(StrDup(10, " ") & Total, 10), FuenteF, Pincel, 860, Y)
                .DrawString(Microsoft.VisualBasic.Left(Anulado & StrDup(10, " "), 10), FuenteF, Pincel, 940, Y)
                Y = Y + 15
                NroFila += 1
                TotalFilas -= 1
