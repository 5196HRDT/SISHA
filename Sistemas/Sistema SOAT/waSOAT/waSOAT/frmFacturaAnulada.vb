Public Class frmFacturaAnulada
    ...
    Private Sub txtSerie_Invalidated(ByVal sender As Object, ByVal e As System.Windows.Forms.InvalidateEventArgs) Handles txtSerie.Invalidated
    ...
    Private Sub btnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        If cboTipo.Text <> "" And txtSerie.Text <> "" And txtNumero.Text <> "" Then
            If MessageBox.Show("Esta seguro de Grabar Comprobante de Venta Anulado", "Mensaje de Consulta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                objFactura.GrabarAnulado(cboTipo.Text, txtSerie.Text, txtNumero.Text, Microsoft.VisualBasic.Format(dtpFDoc.Value, "dd/MM/yyyy"), Microsoft.VisualBasic.Right("00" & Date.Now.Hour, 2) & ":" & Microsoft.VisualBasic.Right("00" & Date.Now.Minute, 2), UsuarioSistema)
            End If
