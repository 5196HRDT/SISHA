...
Public Class FacturacionEconomia
    ...
    Public Function Grabar(ByVal Tipo As String, ByVal Serie As String, ByVal Numero As String, ByVal FechaRegistro As String, ByVal HoraRegistro As String, ByVal UsuarioRegistro As String, ByVal Ruc As String, ByVal RazonSocial As String, ByVal Direccion As String, ByVal Historia As String, ByVal Paciente As String, ByVal Placa As String, ByVal Poliza As String, ByVal SubTotal As String, ByVal IGV As String, ByVal Total As String, ByVal Exonerado As String, ByVal Origen As String) As String
        ...
        daTabla.SelectCommand.Parameters.Add("@SubTotal", SqlDbType.Money).Value = SubTotal
        daTabla.SelectCommand.Parameters.Add("@IGV", SqlDbType.Money).Value = IGV
        daTabla.SelectCommand.Parameters.Add("@Total", SqlDbType.Money).Value = Total
    ...
    Public Function ReporteFacturacionSOAT(ByVal F1 As String, ByVal F2 As String, ByVal RazonSocial As String, Todo As String) As Data.DataSet
        Dim daTabla As New SqlDataAdapter("FacturacionEconomia_ReporteFacturacionSOAT", Cn)
        Dim dstabla As New Data.DataSet
        daTabla.SelectCommand.CommandType = CommandType.StoredProcedure
        ...
        daTabla.SelectCommand.Parameters.Add("@RazonSocial", SqlDbType.VarChar).Value = RazonSocial
        daTabla.SelectCommand.Parameters.Add("@Todo", SqlDbType.Int).Value = Val(Todo)
        daTabla.SelectCommand.ExecuteNonQuery()
        daTabla.Fill(dstabla)
        Return dstabla
    End Function
    ...
    Public Sub Cancelar(ByVal IdFacturacion As String, ByVal FechaCancelado As String, ByVal HoraCancelado As String, ByVal UsuarioCancelado As String, NroCheque As String)
        Dim daTabla As New SqlDataAdapter("FacturaEconomia_Cancelar", Cn)
        daTabla.SelectCommand.CommandType = CommandType.StoredProcedure
        daTabla.SelectCommand.Parameters.Add("@IdFactura", SqlDbType.Int).Value = Val(IdFacturacion)
    ...
    Public Sub CancelarNDoc(ByVal Tipo As String, Serie As String, Numero As String, ByVal FechaCancelado As String, ByVal HoraCancelado As String, ByVal UsuarioCancelado As String, NroCheque As String)
        Dim daTabla As New SqlDataAdapter("FacturaEconomia_CancelarNDoc", Cn)
        daTabla.SelectCommand.CommandType = CommandType.StoredProcedure
        daTabla.SelectCommand.Parameters.Add("@Tipo", SqlDbType.VarChar).Value = Tipo
        daTabla.SelectCommand.Parameters.Add("@Serie", SqlDbType.VarChar).Value = Serie
        daTabla.SelectCommand.Parameters.Add("@Numero", SqlDbType.Int).Value = Val(Numero)
