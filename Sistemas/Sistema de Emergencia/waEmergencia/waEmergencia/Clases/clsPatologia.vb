...
Public Class clsPatologia
    ...
    Public Sub New()
        ...
        Base = Microsoft.VisualBasic.Right(arrText(5), arrText(5).ToString.Length - 9)
    ...
    Public Function BuscarHistoria(ByVal Historia As String) As Data.DataSet
        Do While Cn.State = ConnectionState.Closed
            Cn.Open()
        Loop
        Dim daTabla As New SqlDataAdapter("Informe_ConsultaHistoria", Cn)
    ...
    Public Function ConsultaId(ByVal IdInforme As String) As Data.DataSet
        Do While Cn.State = ConnectionState.Closed
            Cn.Open()
        Loop
        Dim daTabla As New SqlDataAdapter("Informe_ConsultaId", Cn)
        Dim dstabla As New Data.DataSet
        daTabla.SelectCommand.CommandType = CommandType.StoredProcedure
