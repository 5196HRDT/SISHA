Public Class frmPapeletaHospitalizacion
    ...
    Dim objServicioE As New clsServicioEmergencia
    ...
    Private Sub frmPapeletaHospitalizacion_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        'Servicio Emergencia
        Dim dsServicioE As New DataSet
        dsServicioE = objServicioE.Buscar
        cboServicioE.DataSource = dsServicioE.Tables(0)
        cboServicioE.DisplayMember = "Descripcion"
        cboServicioE.ValueMember = "IdServicio"
    ...
    Private Sub cboServicio_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles cboServicio.SelectedIndexChanged
        cboSubServicio.Text = ""
    ...
    Private Sub cboSubServicio_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles cboSubServicio.SelectedIndexChanged
        cboEspecialidad.Text = ""
    ...
    Private Sub txtCie_TextChanged(sender As Object, e As System.EventArgs) Handles txtCie.TextChanged
        If txtCie.Text = "" Then txtDescripcion.Text = ""
    End Sub

    Private Sub txtDescripcion_Invalidated(sender As Object, e As System.Windows.Forms.InvalidateEventArgs) Handles txtDescripcion.Invalidated
    ...
    Private Sub txtDescripcion_TextChanged(sender As Object, e As System.EventArgs) Handles txtDescripcion.TextChanged
    ...
    Private Sub txtFiltro_TextChanged(sender As Object, e As System.EventArgs) Handles txtFiltro.TextChanged
    ...
    Private Sub btnGrabar_Click(sender As Object, e As System.EventArgs) Handles btnGrabar.Click
        If MessageBox.Show("Esta seguro de Solicitar Hospitalización de Paciente?", "Mensaje de Consulta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            ...
            IdPapeleta = objPapeleta.Grabar(Date.Now.ToShortDateString, Date.Now.ToShortTimeString, cboMedico.Text, My.Computer.Name, cboMedico.SelectedValue, cboMedico.Text, "EMERGENCIA", cboServicioE.Text, txtHistoria.Text, lblPaciente.Text, lblFNac.Text, lblEdad.Text, lblSexo.Text, dtpFecha.Value.ToShortDateString, txtMotivo.Text, txtObservaciones.Text, cboServicio.Text, cboSubServicio.Text, cboEspecialidad.Text, "INGRESO")
            Dim I As Integer
    ...
    Private Sub txtHistoria_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles txtHistoria.KeyDown
        If IsNumeric(txtHistoria.Text) And e.KeyCode = Keys.Enter Then
            ...
            'Verificar Papeleta Pendiente de Hospitalizacion
            Dim dsVer As New DataSet
            dsVer = objPapeleta.VerificarPendiente(txtHistoria.Text)
            If dsVer.Tables(0).Rows.Count > 0 Then
                MessageBox.Show("Paciente presenta una papeleta pendiente de Internamiento/Transferencia a: " & dsVer.Tables(0).Rows(0)("Especialidad"), "Mensaje de Información", MessageBoxButtons.OK, MessageBoxIcon.Information)
                btnCancelar_Click(sender, e)
                Exit Sub
            End If
        End If
    ...
    Private Sub btnBuscarP_Click(sender As Object, e As System.EventArgs) Handles btnBuscarP.Click
    ...
    Private Sub cboMedico_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles cboMedico.KeyDown
        If e.KeyCode = Keys.Enter And IsNumeric(cboMedico.SelectedValue) Then cboServicioE.Select()
    End Sub
    ...
    Private Sub cboServicioE_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles cboServicioE.KeyDown
        If e.KeyCode = Keys.Enter And IsNumeric(cboServicioE.SelectedValue) Then txtHistoria.Select()
    End Sub

    Private Sub cboServicioE_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles cboServicioE.SelectedIndexChanged
