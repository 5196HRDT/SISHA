Public Class frmVisor
    ...
    Private Sub frmVisor_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Text = "VISOR IMAGENES - Dr(a) " & NomMedico
    End Sub

    Private Sub txtZoom_Click(sender As Object, e As System.EventArgs) Handles txtZoom.Click
        AplicarZoom()
    End Sub


    Private Sub txtZoom_ValueChanged(sender As System.Object, e As System.EventArgs) Handles txtZoom.ValueChanged

    End Sub

    Private Sub btnBrilloMenos_Click(sender As System.Object, e As System.EventArgs) Handles btnBrilloMenos.Click
        modificar("-brillo")
    End Sub

    Private Sub btnBrilloMas_Click(sender As System.Object, e As System.EventArgs) Handles btnBrilloMas.Click
        modificar("+brillo")
    End Sub
End Class