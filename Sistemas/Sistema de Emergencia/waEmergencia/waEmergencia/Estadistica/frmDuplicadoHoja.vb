Public Class frmDuplicadoHoja
    ...
    Private Sub frmDuplicadoHoja_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub txtHistoria_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtHistoria.KeyDown
        If e.KeyCode = Keys.Enter And IsNumeric(txtHistoria.Text) Then
            ...
            If dsVer.Tables(0).Rows.Count = 0 Then
                MessageBox.Show("Paciente no registra un registro a Emergencia", "Mensaje de Información", MessageBoxButtons.OK, MessageBoxIcon.Information)
                btnCancelar_Click(sender, e)
            Else
                If MessageBox.Show("Paciente presenta un Ingreso a Emergencia sin Alta Médica, Desea Duplicado de Hoja?", "Mensaje de Consulta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                    Oper = 2
                    BuscarHistoria()
    ...
    Private Sub btnGrabar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        ...
        If MessageBox.Show("Esta seguro de Generar Duplicado de Atención?", "Mensaje de Consulta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub cboDpto_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboDpto.SelectedIndexChanged
    ...
    Private Sub cboGrado_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cboGrado.KeyDown
    ...
    Private Sub dtpFechaNcto_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dtpFechaNcto.KeyDown
        If e.KeyCode = Keys.Enter Then cboGrado.Select()
    End Sub

    Private Sub dtpFechaNcto_ValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dtpFechaNcto.ValueChanged
    ...
    Private Sub txtInformante_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtInformante.KeyDown
    ...
    Private Sub txtPaciente_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPaciente.TextChanged
