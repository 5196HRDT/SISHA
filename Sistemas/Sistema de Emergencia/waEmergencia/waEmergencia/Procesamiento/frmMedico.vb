Public Class frmMedico
    ...
    Private Sub frmMedico_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub txtApellidos_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles txtApellidos.KeyDown
        If txtApellidos.Text <> "" And e.KeyCode = Keys.Enter Then txtNombres.Select()
    End Sub

    Private Sub txtApellidos_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtApellidos.TextChanged
    ...
    Private Sub txtCMP_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles txtCMP.KeyDown
        If txtCMP.Text <> "" And e.KeyCode = Keys.Enter Then txtDNI.Select()
    End Sub

    Private Sub txtCMP_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtCMP.TextChanged
    ...
    Private Sub cboFijar_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles cboFijar.KeyDown
        If cboFijar.Text <> "" And e.KeyCode = Keys.Enter Then btnGrabar.Select()
    End Sub

    Private Sub cboFijar_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles cboFijar.SelectedIndexChanged
    ...
    Private Sub txtMedico_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtMedico.TextChanged
        Buscar(txtMedico.Text)
    End Sub
