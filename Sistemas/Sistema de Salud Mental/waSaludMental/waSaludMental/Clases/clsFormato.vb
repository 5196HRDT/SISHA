...
Public Class clsFormato
    ...
    Public Sub Mantenimiento(ByVal IdInforme As String, ByVal Tipo As String, Titulo As String, Informe As String, Documento As Object, Extension As String, Oper As String)
        ...
        daTabla.SelectCommand.Parameters.Add("@Documento", SqlDbType.VarBinary).Value = Documento
    ...
    Public Sub Eliminar(ByVal IdInforme As String)
        Do While Cn.State = ConnectionState.Closed
            Cn.Open()
        Loop
        Dim daTabla As New SqlDataAdapter("InformeSM_Eliminar", Cn)
        Dim dstabla As New Data.DataSet
        daTabla.SelectCommand.CommandType = CommandType.StoredProcedure
        daTabla.SelectCommand.Parameters.Add("@IdInforme", SqlDbType.Int).Value = Val(IdInforme)
        Do While Cn.State = ConnectionState.Closed
    ...
    Public Function Buscar(Titulo As String) As Data.DataSet
        Do While Cn.State = ConnectionState.Closed
            Cn.Open()
        Loop
    ...
    Public Function BuscarId(IdInforme As String) As DataSet
        Do While Cn.State = ConnectionState.Closed
            Cn.Open()
        Loop
        Dim daTabla As New SqlDataAdapter("InformeSM_BuscarId", Cn)
        Dim dstabla As New Data.DataSet
        daTabla.SelectCommand.CommandType = CommandType.StoredProcedure
